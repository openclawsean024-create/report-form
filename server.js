...
// 目標收件信箱
const TARGET_EMAIL = process.env.TARGET_EMAIL || 'sean0407@gmail.com';
...
app.post('/api/submit', upload.single('photo'), async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            bcc: [TARGET_EMAIL, ...ADDITIONAL_RECIPIENTS].join(', '),
            ...
            html: `
                <div style="font-family: 'Noto Sans TC', Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                        <tr>
                            <td style="padding: 12px; background: #f8fafc; border: 1px solid #e2e8f0; font-weight: 600; width: 100px;">
                                商化
                            </td>
                            <td style="padding: 12px; border: 1px solid #e2e8f0; text-align: left;">
                                ${reporter}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding: 12px; border: 1px solid #e2e8f0; text-align: left; white-space: pre-wrap;">
                                ${content.replace(/\n/g, '<br>')}
                            </td>
                        </tr>
                        <tr>
